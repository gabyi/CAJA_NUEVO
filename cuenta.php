          ...
          <td><h2 align="center">Estado de Cuenta:</h2>
            <table class="table-bordered" width="100%" border="2">
              ...
              <tr>
                ...
                <td><div align="right"><? echo number_format(mysql_result($result, 0, "ingresos"),2) ?> </div></td>                
              ...
              <tr>
                ...
                <td><div align="right">- <? echo number_format(mysql_result($result, 0, "egresos"),2) ?> </div></td>
              ...
              <tr>
                ...
                <td><div align="right"><? echo number_format(mysql_result($result, 0, "excedentes") + mysql_result($result, 0, "ingresos") -  mysql_result($result, 0, "egresos") - mysql_result($result, 0, "categoria"),2) ?></div></td>
                <td>&nbsp;</td>
              </tr>
            </table>      
...
<?php
		...
		?>
	    <form id="form1" name="form1" method="post" action="cuenta.php">
